...
export default function SignUp() {
  const API_URL = "https://dj-react-capstone-project.herokuapp.com/register/"
          ...
          <Box component="form" onSubmit={formik.handleSubmit} sx={{ mt: 3 }}>
            ...
            <Grid item xs={12}>
              ...
              <Grid item xs={12}>
                ...
                {formik.touched.password2 && formik.errors.password2 ? <Box sx={{ color: "red", fontSize: 13, ml: 1 }}>{formik.errors.password2} </Box> : null}
              </Grid>
            </Grid>
            <Button
              type="submit"
